...
//		super.onBackPressed();
		...
		//Calculates the size of the adView based on the ad size.
		...
		//Creates the layout parameters using the calculated adView width and height.
		...
		builder.setMessage("Are you sure you want to exit AutoMagic Wallpapers?")
		       .setCancelable(false)
